...
namespace Zombies
{
	public class MinHeap
	{
		...
		public List<WorldTile> heap;

		public MinHeap (WorldTile root){
			heap = new List<WorldTile>();
		...
		public WorldTile GetRoot(){
			WorldTile root = heap[1];
		...
		public void BubbleUp(WorldTile element){
